...
/**
    ...
    public function __construct() {
        ...
        $this->widget_name        = __('WooCommerce Ajax Layered Nav', 'sod_ajax_layered_nav' );
        parent::__construct();
    }
    /*
     * Widgets Fields
            ...
            <?php switch ( $instance['display_type'] ) {
                case "colorpicker":?>
                    <table class="color">
                       <thead>
                            <tr>
                                <td><?php _e('Name', 'sod_ajax_layered_nav');?></td>
                                <td><?php _e('Color Code', 'sod_ajax_layered_nav');?></td>
                            </tr>
                        </thead>
                        <tbody>
                        <?php if($attributes):
                ...
                case "sizeselector":?>
                    <table class="sizes">
                        <thead>
                            <tr>
                                <td><?php _e('Name', 'sod_ajax_layered_nav'); ?></td>
                                <td><?php _e('Label', 'sod_ajax_layered_nav'); ?></td>
                            </tr>
                        </thead>
                        <tbody>
                     <?php if($attributes):
    ...
    public function init_settings() {
        ...
        $this->settings = array(
            'title' => array(
                'type'  => 'text',
                'std'   => __( 'Filter by', 'sod_ajax_layered_nav' ),
                'label' => __( 'Title', 'sod_ajax_layered_nav' )
            ),
            'attribute' => array(
                'type'    => 'select',
                'std'     => '',
                'label'   => __( 'Attribute', 'sod_ajax_layered_nav' ),
            ...
            'show_count'=> array(
                'type'    => 'checkbox',
                'std'     => '',
                'label'   => __( 'Show Attribute Count', 'sod_ajax_layered_nav' ),
            ),
            'hide_empty'=> array(
                'type'    => 'checkbox',
                'std'     => '',
                'label'   => __( 'Hide attributes if filtered count goes to zero', 'sod_ajax_layered_nav' ),
            ),
            'display_type' => array(
                'type'    => 'select',
                'std'     => 'list',
                'class'   => 'layered_nav_type',
                'label'   => __( 'Display type', 'sod_ajax_layered_nav' ),
                'options' => array(
                    'list'          => __( 'List', 'sod_ajax_layered_nav' ),
                    'dropdown'      => __( 'Dropdown', 'sod_ajax_layered_nav' ),
                    'checkbox'      => __( 'Checkbox', 'sod_ajax_layered_nav' ),
                    'sizeselector'  => __( 'Size Selector', 'sod_ajax_layered_nav'),
                    'colorpicker'   => __( 'Color Picker', 'sod_ajax_layered_nav')
                ),
            ),
            'types' => array(
                'type'    => 'typeselector',
                'std'     => '',
                'label'   => __( '', 'sod_ajax_layered_nav' ),
            ...
            'query_type' => array(
                'type'    => 'select',
                'std'     => 'and',
                'label'   => __( 'Query type', 'sod_ajax_layered_nav' ),
                'options' => array(
                    'and' => __( 'AND', 'sod_ajax_layered_nav' ),
                    'or'  => __( 'OR', 'sod_ajax_layered_nav' )
                )
            ),
        );
    }
